...
class CommonViewController: UIViewController {
    ...
    let MSG_LOCATION_REQUIRED = "Please enable location services for the app in the settings. The app will require your location to know when `Live Fit Food Meal Kits` should start preparing for your order. "
